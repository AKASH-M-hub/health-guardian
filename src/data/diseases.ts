...
export const DISEASES: Disease[] = [
  ...
  { id: 93, name: "Hearing Loss", category: "ENT", symptoms: ["Muffled speech", "Difficulty understanding words", "Asking others to repeat", "Turning up volume"], severity: "moderate", prevalence: "Common" },
